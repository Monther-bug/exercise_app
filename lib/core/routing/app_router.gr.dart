...
import 'package:exercise_app/app/app_root_screen.dart' as _i1;
...
import 'package:exercise_app/feature/Auth/presentation/page/sign_up_screen.dart'
    as _i10;
import 'package:exercise_app/feature/error/presentation/empty_view.dart' as _i3;
...
import 'package:exercise_app/feature/home/presentation/pages/favorites.dart'
    as _i5;
import 'package:exercise_app/feature/home/presentation/pages/home.dart' as _i8;
...
abstract class $AppRouter extends _i11.RootStackRouter {
  ...
  final Map<String, _i11.PageFactory> pagesMap = {
    AppRootScreenRoute.name: (routeData) {
    ...
    EmptyViewRoute.name: (routeData) {
      final args = routeData.argsAs<EmptyViewRouteArgs>(
          orElse: () => const EmptyViewRouteArgs());
      return _i11.AutoRoutePage<dynamic>(
        routeData: routeData,
        child: _i3.EmptyView(
...
/// generated route for
/// [_i1.AppRootScreen]
class AppRootScreenRoute extends _i11.PageRouteInfo<void> {
  const AppRootScreenRoute({List<_i11.PageRouteInfo>? children})
      : super(
          AppRootScreenRoute.name,
          initialChildren: children,
        );

  static const String name = 'AppRootScreenRoute';
...
/// generated route for
/// [_i3.EmptyView]
class EmptyViewRoute extends _i11.PageRouteInfo<EmptyViewRouteArgs> {
  EmptyViewRoute({
    String? message,
    _i12.Key? key,
  ...
  static const _i11.PageInfo<EmptyViewRouteArgs> page =
      _i11.PageInfo<EmptyViewRouteArgs>(name);
}

class EmptyViewRouteArgs {
  const EmptyViewRouteArgs({
    this.message,
    this.key,
  });
  ...
  @override
  String toString() {
    return 'EmptyViewRouteArgs{message: $message, key: $key}';
  }
}
